...
[![GithubActions](https://github.com/Zondax/ledger-sei/actions/workflows/main.yml/badge.svg)](https://github.com/Zondax/ledger-sei/blob/main/.github/workflows/main.yaml)
...
This project contains the Sei app for Ledger Nano S+ and X, Stax and Flex.

- Ledger Nano S+/X/Stax/Flex Sei app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-sei/releases). You only need `installer.sh`
